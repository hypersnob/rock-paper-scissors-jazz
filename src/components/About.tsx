...
export function About() {
  return (
    <>
      ...
      <meta
        name="description"
        content="Learn about Hard Rock Paper Scissors game"
      />
        ...
        <div className="space-y-6">
          <section>
            ...
            <div className="space-y-4">
              <p>
                ...
                simultaneous moves. Rock beats Scissors, Scissors beats Paper,
                and Paper beats Rock.
              </p>
              <p>
                In this social version, you can create games, invite friends,
                and track your game history.
              </p>
              <p>
          ...
          <section>
            ...
            <ul className="space-y-2 list-disc list-inside">
              ...
              <li>
                View games you've hosted and games you've played as a guest
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <p>
                You can also sign in to create a permanent account and access
                your game dashboard to view all your games in one place.
              </p>
            </div>
          </section>
          <p>
